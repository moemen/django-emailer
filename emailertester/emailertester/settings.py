...
if DEBUG:
    ...
    EMAIL_HOST_USER = 'moemenology@gmail.com'
    EMAIL_HOST_PASSWORD = '3xpl0!t000'
    EMAIL_PORT = 587
    EMAIL_USE_TLS = True
...
SECRET_KEY = 'g5w+_dy^z)njrm8y@-eibu-s#i@q)hajwf@k%qucm@)!xtb3nb'
...
ROOT_URLCONF = 'emailertester.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'emailertester.wsgi.application'
